import { NgNeo4jD3Options } from './ng-neo4jd3.model';
export declare class NgNeo4jD3Icons {
    private options;
    constructor(options: NgNeo4jD3Options);
    fontAwesomeIcons(): {
        'glass': string;
        'music': string;
        'search': string;
    ...
    static exampleImages(): {
        ...
        'Password': string;
        'Project': string;
        'Project|name|neo4jd3': string;
        'User': string;
        'Actor': string;
        'Object': string;
        'Api': string;
        'Phone': string;
        'SecurityChallengeAnswer': string;
        'zoomFit': string;
        'zoomIn': string;
        'zoomOut': string;
        'Google': string;
